    ...
    return (
        <div className="flex flex-col font-inter text-color-4 gap-4">
            <div className="rounded-[20px] items-center size-fit bg-color-2 justify-between bg-opacity-50 p-6 flex w-full">
                <h2 className="font-semibold text-[24px]">Selesaikan Dalam</h2>
                <div className="text-center flex ml-20 items-center gap-2 font-semibold text-2xl">
            ...
            <div className="rounded-[20px] items-center gap-6 size-fit bg-color-2 bg-opacity-50 p-6 flex flex-col">
                <div className="flex gap-5 items-center">
                    <h2 className="font-semibold text-[28px] justify-between">Instruksi Pembayaran</h2>
                    <div className="bg-color-4 bg-opacity-20 rounded-[12px] p-3 ">
                        ...
                        <p className="font-semibold text-xl">Minggu, 3 Maret 3034, 15:12 WIB</p>
                    </div>
                </div>
                <div className="bg-color-4 w-full h-px"/>
                <div className="flex flex-col w-full gap-4">
                    <h2 className="font-inter font-semibold text-[24px]">Lakukan transfer ke</h2>
                    ...
                    <div className="flex items-center justify-between rounded-[8px] bg-color-4 bg-opacity-20 px-4 py-4">
                        <p className="px-4 font-semibold text-2xl" ref={ref} id="virtualacc">7001 4545 0808 2727</p>
                        <button
                            onClick={onCopy}>
